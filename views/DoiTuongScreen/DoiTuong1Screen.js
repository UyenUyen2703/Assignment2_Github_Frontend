...
import { Text, View, ScrollView, TextInput, TouchableOpacity, Keyboard, Platform, Alert, Modal, Pressable } from 'react-native';
...
const DoiTuong1Screen = ({ DATA_DiemHocLuc, setDATA_DiemHocLuc }) => {
                                ...
                                <View style={styles.inputField}>
                                    ...
                                    <View style={styles.inputFieldRow}>
                                        ...
                                        <TextInput style={styles.inputFieldInput}
                                            ...
                                            onChangeText={(text) =>
                                                handleUpdateDATA('diemDanhGiaNangLuc', parseFloat(text))}
                                        />
                                    </View>
                                    <View style={styles.inputFieldRow}>
                                        <Text style={styles.inputFieldInputLabel}>
                                        ...
                                        <TextInput style={styles.inputFieldInput}
                                            ...
                                            placeholderTextColor={'#969696ff'}
                                            keyboardType="numeric"
                                            onChangeText={(text) => handleUpdateDATA('diemToan', parseFloat(text))}
                                        />
                                    </View>
                                </View>
...
export default DoiTuong1Screen;