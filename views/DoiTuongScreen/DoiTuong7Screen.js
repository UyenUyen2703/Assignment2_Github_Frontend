...
const DoiTuong7Screen = ({ DATA_DiemHocLuc, setDATA_DiemHocLuc }) => {
        ...
        <ScrollView style={{ width: '100%' }}>
            <View style={styles.container}>
                <View style={styles.titleContainer}>
                    <Text style={styles.titleText}>{'Thí Sinh Tốt Nghiệp THPT Nước Ngoài'}</Text>
                </View>
                                ...
                                <View style={styles.inputField}>
                                    ...
                                    <View style={[styles.inputFieldRow]}>
                                        ...
                                        <TouchableOpacity style={[styles.inputFieldInput, { flex: 1 }]}
                                            ...
                                            <Text style={[styles.inputFieldPickerText,
                                            ChungChi != null && { color: '#000000' }]}>
...
export default DoiTuong7Screen;